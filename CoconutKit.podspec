Pod::Spec.new do |s|
  s.name = 'CoconutKit'
  s.version = '1.1.4.snapsendsolve'
  s.license = 'MIT'
  s.summary = 'CoconutKit is a library of high-quality iOS components.'
  s.homepage = 'https://github.com/inadilemma/CoconutKit'
  s.author = { 'Samuel Défago' => 'defagos@gmail.com' }
  s.source = { :git => 'https://github.com/inadilemma/CoconutKit.git', :tag => '1.1.4.snapsendsolve' }
  s.platform = :ios, '4.0'
